...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findPreference(getString(R.string.preference_clear_database)).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                new MaterialDialog.Builder(getActivity())
                        .title(R.string.preference_clear_database_confirmation)
                        .cancelable(true)
                        .positiveText(android.R.string.yes)
                        .negativeText(android.R.string.cancel)
                        .negativeColor(getResources().getColor(R.color.material_green_700))
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                Toast.makeText(SettingsFragment.this.getActivity(), R.string.database_clear_success, Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
                return false;
